...
(쇼핑몰사이트에서 쇼핑을 하고있을때 사용자가 새로고침을 하지 않는다면 공지사항이 있어도 확인하지 못하지만, socket을 사용하는 경우(ex.게임) 실시간 공지사항을 확인할 수 있습니다.)

client는 아래에서 확인 가능합니다.

<br>
https://github.com/jaeho310/python_socket_client
